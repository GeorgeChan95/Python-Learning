...
if __name__ == '__main__':
    ...
    pool.join()
'''
当前执行的进程id: 31896, 进程名称：poo1
当前执行的进程id: 9088, 进程名称：poo2
当前执行的进程id: 2200, 进程名称：poo3
当前执行的进程id: 26032, 进程名称：poo4
当前执行的进程id: 33432, 进程名称：poo5
当前执行的进程id: 31896, 进程名称：poo6接收到：poo1_1

当前执行的进程id: 9088, 进程名称：poo7
接收到：poo2_1
接收到：poo3_1
接收到：poo4_1
接收到：poo5_1
